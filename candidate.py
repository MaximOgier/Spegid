...
from your.your.your import Your
...
#            print('dedisp0 =', len(self.dedispersed[0]))
#            print('dedisp1 =', len(self.dedispersed[1]))
#            print('dedisp1-0 =', self.dedispersed[1][0])
#            print('dedisp1-0 =', self.dedispersed[1][-1])
#            print('dedisp0-0 =', self.dedispersed[0][0])
#            print('dedisp0-0 =', self.dedispersed[0][-1])
        else:
    ...
    def dedispersets(self, dms=None):
        ...
        """
#        print('shape2 =' + str(self.data.shape))
        if dms is None:
            dms = self.dm
        if self.data is not None:
            nt, nf = self.data.shape
...
#            print( 'ts[-1] =', ts[-1])
    ...
    def dmtime(self, dmsteps=256, target="CPU"):
        ...
        """
        if target == "CPU":
            dm_list = self.dm + np.linspace(-1, 1, dmsteps)
#            print('dm_list =' + str(len(dm_list)))
...
#            print('dmt0 =', len(self.dmt[0]))
#            print('dmt1 =', len(self.dmt[1]))
#            print('dmt1-0 =', self.dmt[1][0])
#            print('dmt1--1 =', self.dmt[1][-1])
#            print('dmt0-0 =', self.dmt[0][0])
#            print('dmt0--1 =', self.dmt[0][-1])
        elif target == "GPU":
